...
<style lang="scss">
    ...
    .twilightFanfic .title, .twilightFanfic #fanfic-nav button:hover, .twilightFanfic .sourceLink a, .twilightFanfic .author, .twilightFanfic .author a{
        color: $twilightThemeColor1;
        transition: $baseTransition;
    }
    .celestiaFanfic .title, .celestiaFanfic #fanfic-nav button:hover, .celestiaFanfic .sourceLink a, .celestiaFanfic .author, .celestiaFanfic .author a{
        color: $celestiaThemeColor2;
        transition: $baseTransition;
    }
    .lunaFanfic .title, .lunaFanfic #fanfic-nav button:hover, .lunaFanfic .author{
        color: $lunaThemeColor4;
        transition: $baseTransition;
    }
    .lunaFanfic .author, .lunaFanfic .wordCount, .lunaFanfic .sourceLink a,  .lunaFanfic .author a{
